import { UserTC } from "./User_model.js";
import bcrypt from "bcrypt";
import { schemaComposer } from "graphql-compose";
import jwt from "jsonwebtoken";
const SingUpInput = schemaComposer.createInputTC({
    name: "SingUpInput",
    fields: {
        First_name: "String",
        Last_name: "String",
...
const SingInInput = schemaComposer.createInputTC({
    name: "SingInInput",
    fields: {
        email: "String",
        password: "String",
...
export const currentUser = schemaComposer.createResolver({
    ...
    resolve: async ({ context }) => {
        const userTokenHeader = context.setHeaders.find((header) => header.key === "userToken");
